# kreuzwort-kryptisch
Kryptische Kreuzworträtsel (Cryptic Crosswords) auf Deutsch

Die hier nach und nach zu sammelnden Kreuzworträtsel haben zum Ziel, in deutscher Sprache dem Vorbild der englischen Cryptic Crosswords näher zu kommen.
Es ist offensichtlich, daß Deutsch dafür in vielerlei Hinsicht weniger geeignet ist als Englisch. 
Trotzdem (oder vielleicht gerade deshalb) könnte es reizvoll sein, die Grenzen der Möglichkeiten auszuloten und nicht vorschnell zu resignieren.

## Einführendes Beispiel
_Lindau in Furcht: Ist Wissenschaftler für englische Kultur? (7)_ - ANGLIST  
Definition: Wissenschaftler für englische Kultur  
Wortspiel:  
...
* Jeder Clue besteht aus 2 Teilen:
    * Einer Definition, die das zu findende Wort (es können auch mehrere sein) beschreibt. Das muß nicht zwingend ein nüchternes Synonym, sondern
      kann auch eine Umschreibung sein. Per Konvention steht die Definition am Anfang oder am Ende des Clues.
    * Einem Wortspiel (engl. "Wordplay"), d.h. mit verschiedenen Techniken wie z.B. Anagramm, Scharade, Akrostichon, ... wird die Lösung konstruiert.
      Wichtig: Das Wortspiel hat nicht zwingend etwas mit dem Sinnfeld der gesuchten Lösung zu tun. Im Gegenteil, meistens versucht das Wortspiel,
      die Lösenden neckisch aufs Glatteis zu führen. Wichtig ist aber die Fairness, d.h. die richtige Lösung muß immer eindeutig erschließbar sein.
* Definition und Wortspiel zusammen ergeben die sogenannte Oberfläche (engl. "Surface"). In gewisser Hinsicht könnte man sagen daß eine gelungene
Oberfläche nicht weniger wichtig ist als eine verständliche Definition und ein faires Wortspiel. Zum Genuß des Lösungsvorgehens trägt die Oberfläche
nicht unwesentlich bei.
* Jedes Wortspiel wird von einem Indikator angekündigt. Die Liste der Indikatoren pro Wortspiel-Typ ist nicht geschlossen, für Setzer
(die Autoren von Kreuzworträtseln) wie auch für die Lösenden ist es mehr eine Sache von Erfahrung, Intuition, Konvention. Einige Beispiele:
    * "kaputt", "nervös", "neugeordnet", ... als Indikatoren für ein Anagramm (Anagramm Indikator, "Anagrind"). Also z.B. "<ins>schrecklicher</ins> Ton" -> "NOT".
...
* Quellen und Material für Abkürzungen (die dann als Teile von Wörtern verwendet werden) sind mannigfaltig. Z.B. ist es Praxis, u.a. die folgenden Quellen heranzuziehen:
    ...
    * [Deutsche Kfz-Kennzeichen](https://de.wikipedia.org/wiki/Liste_aller_Kfz-Kennzeichen_der_Bundesrepublik_Deutschland): Natürlich kann man von niemandem erwarten zu 
    wissen was das Kennzeichen von Ulm ist ("UL"). Aber die Erwartung ist dass Lösende in der Lage sind, so etwas im Internet problemlos zu recherchieren.
    * [Kfz-Nationalitätszeichen](https://de.wikipedia.org/wiki/Liste_der_Kfz-Nationalit%C3%A4tszeichen), z.B. "D", "E", "A", ...
    * [Chemische Elemente](https://de.wikipedia.org/wiki/Liste_der_chemischen_Elemente), z.B. "C", "O", "NE", ...
    * [ICAO Alphabet](https://de.wikipedia.org/wiki/ICAO-Alphabet), auch als NATO Alphabet bekannt: z.B. "Alfa" für "A", "Charlie" für "C", "Golf" für "G" ...
    * [Wikipedia Abkürzungsliste](https://de.wikipedia.org/wiki/Kategorie:Liste_(Abk%C3%BCrzungen)) - hier ist natürlich Augenmaß gefragt: Allzu exotisches
...
* Sonderzeichen, Satzzeichen, Umlaute, Groß- und Kleinschreibung
    ...
    * Sämtliche Satzzeichen werden in der Lösung ignoriert (es gibt keine Bindestriche, ...).
    * Satzzeichen, Groß- und Kleinschreibung im Clue können vom Setzer als Mittel zur Irreführung der Lösenden verwendet werden. Die Lösenden müssen jederzeit 
    im Auge behalten, daß Kommata, Anführungszeichen, Gedankenstriche, ... hauptsächlich der Konstruktion einer befriedigenden Oberfläche dienen.
* Jedem Clue folgt in Klammern eine Angabe zur Buchstabenanzahl. Normalerweise ist das nur eine Zahl wie z.B. "(7)", aber im Fall von mehreren Wörtern kann es auch wie 
"5,2" (2 Wörter) oder "4-3" (Bindestrich zwischen 2 Wörtern) aussehen.
